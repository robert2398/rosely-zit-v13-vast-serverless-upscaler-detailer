...
MODEL_S3_URI="${MODEL_S3_URI:-s3://rosely-infrastructure/serverless/zimage/zenith13/zenith13-mxfp8-full-detailer-seedvr2-v3.tar.zst}"
MODEL_ARCHIVE_SHA256="${MODEL_ARCHIVE_SHA256:-cfbd87e06b3b570c40c1436bea5cb31c0b1c70b772254d13791162f41df64fb7}"
MODEL_ARCHIVE_SIZE="${MODEL_ARCHIVE_SIZE:-16309405103}"
